...
<input type="hidden" name="accion" value="darseDeBaja"/>
...
<%
String[] literales = {email};
%>
<%=UtilidadesTexto.obtenerConfirmacionConBoton(UtilidadesTexto.sustituirLiterales(TextConstant.CONFIRMAR_BAJA,literales),TextConstant.IMAGEN_WRN_P)%>
