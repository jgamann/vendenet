 ...
 * Ventana&gt;Preferencias&gt;Java&gt;Generación de código&gt;Código y comentarios
 */
public class ProcesoControlNegocio {
	private Logger logger = Logger.getLogger(ProcesoControlNegocio.class);
	Properties propiedadesSistema=new Properties();
	/**
	 * 
	 */
	public ProcesoControlNegocio(String ruta) {
		FileInputStream fis = null;
		try{
			fis = new FileInputStream(ruta.concat(ConstantesVendenet.ficheroActividadWeb));
