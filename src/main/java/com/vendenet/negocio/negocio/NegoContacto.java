 ...
 * Ventana&gt;Preferencias&gt;Java&gt;Generación de código&gt;Código y comentarios
 */
public class NegoContacto {
	private Logger logger = Logger.getLogger(NegoContacto.class);
	...
	public void obtenerTexto() throws ErrorVendenet {
		try{
			hsResultados.put(TextConstant.KEY_RESPUESTA, TextConstant.CONTACTO);
		}catch(Exception eError){
			hsResultados.put(TextConstant.KEY_RESPUESTA, "");
			logger.error("Error en NegoContacto - obtenerTexto"+eError);
