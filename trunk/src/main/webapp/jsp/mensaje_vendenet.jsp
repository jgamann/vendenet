...
String mensaje=(String)hResultados.get(TextConstant.KEY_MENSAJE);
%>
...
<%=TextConstant.APERTURA_DIV_CAPA_PRELIMINAR_ANUNCIO%>
<%=TextConstant.APERTURA_DIV_CAPA_FONDO_SOMBREADO%>
<%=TextConstant.APERTURA_DIV_CENTRADO_IZQUIERDA%>
<%=mensaje%>
