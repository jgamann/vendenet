...
<%@page import="com.vendenet.utilidades.UtilidadesWebsAmigas"%>
...
<!-- meta name="google-site-verification" content="3PZTzOXuOsqZOwO86lr6r-WEB_sp5c8lYlreQMbA0qY" /> -->
...
<script type="text/javascript" src="js/indexv6.js"></script>
...
<button id="botonsearch" name="boton" type="submit" class="class_boton_buscar"><img src="imagenes/buscar.png" alt="Buscar"/></button>
</div>
</div>
<div class="menu_izquierda">
<div style="float: left; text-align:left;" id="menu_izq" class="sdmenu">
      <div class="titulo_scroll">
        <span>Provincia - <%=((provinciaSeleccionada!=null)&&(provinciaSeleccionada.getId()!=0))?provinciaSeleccionada.getNamelong():TextConstant.TODAS%></span>
      ...
      <div class="titulo_scroll">
        <span><%=TextConstant.CATEGORIA_GUION%><%=((categoriaSeleccionada!=null)&&(categoriaSeleccionada.getId()!=0))?categoriaSeleccionada.getName():TextConstant.TODAS%></span>
